    ...
    <div className="h-screen w-full flex overflow-hidden bg-white dark:bg-gray-900">
      ...
      <div
        className="
          ...
          px-12 sm:px-14 md:px-24 lg:px-32 xl:px-40 2xl:px-52
        "
      >
        {/* Logo */}
        <Link to="/" className="block text-center mb-4 sm:mb-6">
          <img
            src="/images/logo/logoos.jpg"
            alt="logo"
            className="w-[220px] h-[220px] sm:w-[250px] sm:h-[250px] object-cover mx-auto"
          />
        </Link>

        {/* FORM CONTAINER – wider now */}
