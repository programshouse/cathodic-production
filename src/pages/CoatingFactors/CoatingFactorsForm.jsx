...
export default function CoatingFactorsForm({ onSubmit, submitting }) {
  const [coatingType, setCoatingType] = useState("fbe");
    ...
    <div className="mb-6">
      <div className="relative overflow-hidden rounded-2xl">
        ...
        <div className="relative px-5 py-5 md:px-7 md:py-6">
          ...
          <p className="text-brand-50/90 text-sm md:text-base mt-1">Enter coating type and design life.</p>
        </div>
      </div>
    </div>
  );
    ...
    >
          ...
          <div>
            ...
            <div className="flex gap-2">
              <NumberInput
                ...
                onChange={(e) => setDesignLifeYears(e.target.value)}
                required
              />
      ...
      <div className="flex items-center gap-3">
        <PrimaryButton type="submit" disabled={submitting}>
          {submitting ? "Calculating..." : "Calculate Coating Factors"}
        </PrimaryButton>
      </div>
    </form>
  );
