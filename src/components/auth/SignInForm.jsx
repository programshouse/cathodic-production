...
export default function SignInForm() {
  ...
  const { login, loading, error, access_token, checkSession, loadUserFromStorage } = useAuthStore();
  ...
  useEffect(() => {
    if (access_token && checkSession()) {
      navigate("/");
    }
  }, [access_token, checkSession, navigate]);
          ...
          <Formik
            ...
            onSubmit={async (values, { setSubmitting, setStatus }) => {
              ...
              try {
                ...
                setStatus(serverMsg || (e instanceof Error ? e.message : "Sign in failed. Try again."));
              } finally {
                setSubmitting(false);
              }
            }}
            ...
            {({
              ...
              <form onSubmit={handleSubmit} noValidate>
                ...
                <div className="space-y-5">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <Input
                        ...
                        className={`pr-10 ${touched.password && errors.password ? "ring-1 ring-red-400 focus:ring-red-500" : ""}`}
                      />
                      <button
                        type="button"
                  ...
                  {/* Submit */}
                  <div>
                    <Button className="w-full" size="md" type="submit" disabled={loading || isSubmitting}>
